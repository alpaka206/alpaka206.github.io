...
> - 소프트웨어 개발 보안 점검 항목은 소프트웨어 개발의 각 단계에서 점검되어야 할 보 안 항목들을 말한다.
...
- API 오용
  ...
  - 보안약점에는 DNS lookup에 의존한 보안결정, 취약한 API 사용이 있다.

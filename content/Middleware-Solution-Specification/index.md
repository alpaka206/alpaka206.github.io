...
- 시스템들을 1:1, 1:N. NM 등 여러 가지 형태로 연결할 수 있다.
...
- 대표적인 MOM의 종류에는 IBM의 MQ, 오라클의 Message Q, JCP의 JMS 등이있다.

## TP-Monitor(Transaction Processing Monitor)

> - TP-Monitor(트랜잭션 처리 모니터)는 항공기나 철도 예약 업무 등과 같은 온라인 트랜잭션 업무에서 트랜잭션 처리 및 감시하는 미들웨어이다.

- 사용자 수가 증가해도 빠른 응답 속도를 유지해야 하는 업무에 주로 사용된다.
- 대표적인 TP-Monitor의 종류에는 오라클의 tuxedo, 티맥스소프트의 trmax 등이 있다.
...
- 작성된 미들웨어 솔루션 목록은 이해관계자 등에게 전달하여 오류 및 누락을 확인 하고 수정한다.
  ![](https://velog.velcdn.com/images/alpaka206/post/7a07d00a-07ab-4034-9706-636fcf8e9f3f/image.png)

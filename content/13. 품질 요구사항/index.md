...
- ### ISO/IEC 9126
  ...
  - ![](https://velog.velcdn.com/images/alpaka206/post/aaf20582-5685-4889-8cb1-c3fb04c8d00a/image.png)
- ### ISO/IEC 25010
  - ISO/IEC 25010은 소프트웨어 제품에 대한 국제 표준으로, 2011년에 ISO/IEC 9126을 개정하여 만들었다.
  - ISO/IEC 25010에서 제시한 소프트웨어의 품질 특성
  - ![](https://velog.velcdn.com/images/alpaka206/post/4c2ce9d7-987c-42e8-b065-07f3703e7ef2/image.png)
- ### 기타 소프트웨어 품질 관련 표준
  - ISO/IEC 12119 : ISO/IEC 9126을 준수한 품질 표준으로 테스트 절차를 포함하여 규정함
  - ISO/IEC 14598 : 소프트웨어 품질의 측정과 평가에 필요 절차를 규정한 표준으로 개발자 구매자 평가자별로 수행해야 할 제품 평가 활동을 규정함
...
| 보안성(Security)              | 정보에 대한 접근권한에 따라 허용하거나 차단할 수 있는 능력                |
| 준수성(Compliance)            | 기능과 관련된 표준관례 및 규정을 준수할 수 있는 능력                      |
...
| 회복성(Recoverability)       | 고장시 규정된 성능 수준까지 다시 회복하고 직접적으로 영향 받은 데이터를 복구할 수 있는 능력 |
...
| 학습성(Leanability)       | 소프트웨어 애플리케이션을 학습할 수 있도록 하는 능력             |
...
| 상세 품질 요구사항              | 설명                                                                              |
| ------------------------------- | --------------------------------------------------------------------------------- |
| 시간효율성(Time Behaviour)      | 특정 기능을 수행할 때 적절한 반응 시간 및 처리 시간, 처리율을 제공할 수 있는 능력 |
...
| 변경성(Changeability) | 결합제거 또는 환경 변화로 인한 수정 등을 쉽게 구현할 수 있는 능력 |

...
- 자료 흐름도에서는 자료의 흐름과 기능을 프로세스(Process), 자료 흐름(Flow), 자료 저장소(Data Store), 단말(Treminator)의 네가지 기본 기호로 표시![](https://velog.velcdn.com/images/alpaka206/post/3e520d0f-2610-4d46-b8e1-d0719bc73cc9/image.png)
...
| \[ \| ] | 자료의 선택: 또는(or)                                                                                                        |
|   { }   | 자료의 반복: Iteration of<br>1. $$\{\}_n$$: n번 이상 반복, 2.$$\{\}^n$$: 최대로 n번 반복, 3.$$\{\}_m^n$$: m이상 n이하로 반복 |
|  \* \*  | 자료의 설명: 주석(Comment)                                                                                                   |

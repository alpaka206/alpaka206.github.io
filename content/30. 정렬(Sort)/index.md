...
- 평균과 최악 모두 수행 시간 복잡도는 O($$n^2$$)이다.![](https://velog.velcdn.com/images/alpaka206/post/164acd44-e9ff-46be-9b40-9b4695a54385/image.png)

## 쉘 정렬(Shell Sort)

> - 쉘 정렬은 삽입 정렬(Insertion Sort)을 확장한 개념이다.

- 입력 파일을 어떤 매개변수(h)의 값으로 서브파일을 구성하고, 각 서브파일을 Insertion 정렬 방식으로 순서 배열하는 과정을 반복하는 정렬 방식(보통 h=$$^3\sqrt n$$), 즉 임의의 레코드 키와 값만큼 떨어진 곳의 레코드 키를 비교하여 순서화되어 있지 않으면 서로 교환하는 것을 반복하는 정렬 방식이다.
...
- 평균과 최악 모두 수행 시간 복잡도는 O($$n^2$$)이다.![](https://velog.velcdn.com/images/alpaka206/post/b3d69e70-ccc0-43ca-a9a7-c69e0f86fa02/image.png)
...
- 평균과 최악 모두 수행 시간 복잡도는 O($$n^2$$)이다.![](https://velog.velcdn.com/images/alpaka206/post/0735c9b1-0942-48d0-beb3-6b3c0a3debd8/image.png)
...
- 평균과 최악 모두 시간 복잡도는 O(n$$log_2n$$)이다.![](https://velog.velcdn.com/images/alpaka206/post/c1fa233a-33c7-40d9-a621-089da79d492d/image.png)
...
- 평균과 최악 모두 시간 복잡도는 O(n$$log_2n$$)이다.![](https://velog.velcdn.com/images/alpaka206/post/b1a1e870-abda-482e-8b21-a2710ecdc9b2/image.png)
